...
const long interval = 2000; // Interval waktu dalam milidetik  
...
void Datalog() {
  ...
  String namaFile = getDayStr + getMonthStr + String(now.getYear(), DEC) + "_TxPower " + String(setTxPower);
...
void DatalogMeasurement() {
  ...
  String getMonthStr = now.getMonth() < 10 ? "0" + String(now.getMonth()) : String(now.getMonth());
  String getDayStr = now.getDay() < 10 ? "0" + String(now.getDay()) : String(now.getDay());
  String namaFile = getDayStr + getMonthStr + String(now.getYear(), DEC) + "_measurementlog_TxPower " + String(setTxPower);
